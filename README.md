...
- Para conservar su trabajo, descargue el archivo `.ipynb` individual desde las opciones de la página.
- Para obtener todo el material, descargue o clone el [repositorio completo](https://github.com/Icesi-MA/Matematicas-Aplicadas-II).
- Los archivos `.ipynb` descargados pueden abrirse en Google Colab o JupyterLab.
